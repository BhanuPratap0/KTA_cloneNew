...
function Products() {
    return (
        <div id={styles.Products} >
            ...
            <TopBanner details='Explore our premium range of tile adhesives designed for superior bonding and durability, suitable for various tile installations.' head='src/Assets/ProductsPage/ProductsHeading.svg' />
